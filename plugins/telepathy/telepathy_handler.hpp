...
#define REMMINA_TP_HANDLER_CLASS( obj ) \
    ( G_TYPE_CHECK_CLASS_CAST( ( obj ), REMMINA_TYPE_TP_HANDLER, RemminaTpHandlerClass ) )
...
#define REMMINA_TP_HANDLER_GET_CLASS( obj ) \
    ( G_TYPE_INSTANCE_GET_CLASS( ( obj ), REMMINA_TYPE_TP_HANDLER, RemminaTpHandlerClass ) )

struct RemminaTpHandler
{
    GObject parent;
};

struct RemminaTpHandlerClass
{
