...
static GOptionEntry remmina_options[] = {
    ...
    { "connect",
      ...
      NULL,
      N_( "Connect either to a desktop described in a file (.remmina or a filetype supported by a plugin) or a "
          "supported URI (RDP, VNC, SSH or SPICE)" ),
      N_( "FILE" ) },
    // TRANSLATORS: Shown in terminal. Do not use characters that may be not supported on a terminal
    { G_OPTION_REMAINING,
      '\0',
      ...
      G_OPTION_ARG_FILENAME_ARRAY,
      NULL,
      N_( "Connect to a desktop described in a file (.remmina or a filetype supported by a plugin)" ),
      N_( "FILE" ) },
    // TRANSLATORS: Shown in terminal. Do not use characters that may be not supported on a terminal
    { "edit",
      'e',
      ...
      G_OPTION_ARG_FILENAME_ARRAY,
      NULL,
      N_( "Edit desktop connection described in file (.remmina or a filetype supported by plugin)" ),
      N_( "FILE" ) },
    ...
    { "update-profile",
      ...
      NULL,
      N_( "Modify connection profile (requires --set-option)" ),
      NULL },
    // TRANSLATORS: Shown in terminal. Do not use characters that may be not supported on a terminal
    { "set-option",
      0,
      ...
      NULL,
      N_( "Set one or more profile settings, to be used with --update-profile" ),
      NULL },
...
static void remmina_on_startup( GApplication *app )
{
	...
	* windows with .desktop file which has the same StartupWMClass */
    ...
    else if( !secret_plugin->is_service_available() )
...
static gint remmina_on_local_cmdline( GApplication *app, GVariantDict *opts, gpointer user_data )
{
    ...
    if( g_variant_dict_lookup( opts, "update-profile", "^&ay", &str ) )
    { /* ^&ay no need to free */
...
#    endif /* !GCRYPT_VERSION_NUMBER */
    ...
    g_application_set_option_context_parameter_string( G_APPLICATION( app ),
                                                       _( "- or protocol://username:encryptedpassword@host:port" ) );
    // TRANSLATORS: Shown in terminal. Do not use characters that may be not supported on a terminal
    g_application_set_option_context_description(
        ...
        _( "Examples:\n"
           ...
           "\n"
           "\techo \"username\\napassword\" | remmina --update-profile /PATH/TO/FOO.remmina --set-option username "
           "--set-option resolution_mode=2 --set-option password\n" ) );
#endif
