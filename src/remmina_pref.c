...
static void remmina_pref_init_keymap( void )
{
    ...
    if( !g_key_file_load_from_file( gkeyfile, remmina_keymap_file, G_KEY_FILE_NONE, NULL ) )
    {
        if( !g_key_file_load_from_data(
                gkeyfile, default_keymap_data, strlen( default_keymap_data ), G_KEY_FILE_NONE, NULL ) )
        {
...
void remmina_pref_init( void )
{
    ...
    if( g_file_test( remmina_dir, G_FILE_TEST_IS_DIR ) )
    {
        ...
        remmina_pref_file_do_copy( g_build_path( "/", remmina_dir, filename, NULL ),
                                   g_build_path( "/", g_get_user_config_dir(), "remmina", filename, NULL ) );
    }
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "use_master_password", NULL ) )
        remmina_pref.use_master_password =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "use_master_password", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "fullscreen_on_auto", NULL ) )
        remmina_pref.fullscreen_on_auto =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "fullscreen_on_auto", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "floating_toolbar_placement", NULL ) )
        remmina_pref.floating_toolbar_placement =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "floating_toolbar_placement", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "prevent_snap_welcome_message", NULL ) )
        remmina_pref.prevent_snap_welcome_message =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "prevent_snap_welcome_message", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "last_quickconnect_protocol", NULL ) )
        remmina_pref.last_quickconnect_protocol =
            g_key_file_get_string( gkeyfile, "remmina_pref", "last_quickconnect_protocol", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "hide_connection_toolbar", NULL ) )
        remmina_pref.hide_connection_toolbar =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "hide_connection_toolbar", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "main_sort_column_id", NULL ) )
        remmina_pref.main_sort_column_id =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "main_sort_column_id", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "deny_screenshot_clipboard", NULL ) )
        remmina_pref.deny_screenshot_clipboard =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "deny_screenshot_clipboard", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "ssh_tcp_usrtimeout", NULL ) )
        remmina_pref.ssh_tcp_usrtimeout =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "ssh_tcp_usrtimeout", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "applet_enable_avahi", NULL ) )
        remmina_pref.applet_enable_avahi =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "applet_enable_avahi", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "list_refresh_workaround", NULL ) )
        remmina_pref.list_refresh_workaround =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "list_refresh_workaround", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "fullscreen_toolbar_visibility", NULL ) )
        remmina_pref.fullscreen_toolbar_visibility =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "fullscreen_toolbar_visibility", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_fullscreen", NULL ) )
        remmina_pref.shortcutkey_fullscreen =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_fullscreen", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_autofit", NULL ) )
        remmina_pref.shortcutkey_autofit =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_autofit", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_nexttab", NULL ) )
        remmina_pref.shortcutkey_nexttab =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_nexttab", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_prevtab", NULL ) )
        remmina_pref.shortcutkey_prevtab =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_prevtab", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_viewonly", NULL ) )
        remmina_pref.shortcutkey_viewonly =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_viewonly", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_multimon", NULL ) )
        remmina_pref.shortcutkey_multimon =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_multimon", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_minimize", NULL ) )
        remmina_pref.shortcutkey_minimize =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_minimize", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_screenshot", NULL ) )
        remmina_pref.shortcutkey_screenshot =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_screenshot", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_disconnect", NULL ) )
        remmina_pref.shortcutkey_disconnect =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_disconnect", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "shortcutkey_toolbar", NULL ) )
        remmina_pref.shortcutkey_toolbar =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "shortcutkey_toolbar", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "vte_allow_bold_text", NULL ) )
        remmina_pref.vte_allow_bold_text =
            g_key_file_get_boolean( gkeyfile, "remmina_pref", "vte_allow_bold_text", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "vte_shortcutkey_copy", NULL ) )
        remmina_pref.vte_shortcutkey_copy =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "vte_shortcutkey_copy", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "vte_shortcutkey_paste", NULL ) )
        remmina_pref.vte_shortcutkey_paste =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "vte_shortcutkey_paste", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "vte_shortcutkey_select_all", NULL ) )
        remmina_pref.vte_shortcutkey_select_all =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "vte_shortcutkey_select_all", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "vte_shortcutkey_increase_font", NULL ) )
        remmina_pref.vte_shortcutkey_increase_font =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "vte_shortcutkey_increase_font", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "vte_shortcutkey_decrease_font", NULL ) )
        remmina_pref.vte_shortcutkey_decrease_font =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "vte_shortcutkey_decrease_font", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_pref", "vte_shortcutkey_search_text", NULL ) )
        remmina_pref.vte_shortcutkey_search_text =
            g_key_file_get_integer( gkeyfile, "remmina_pref", "vte_shortcutkey_search_text", NULL );
    else
    ...
    if( RMNEWS_ENABLE_NEWS == 0 )
        ...
        remmina_pref.periodic_news_permitted =
            g_key_file_get_boolean( gkeyfile, "remmina_news", "periodic_news_permitted", NULL );
    else
        remmina_pref.periodic_news_permitted = RMNEWS_ENABLE_NEWS;
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_news", "periodic_rmnews_last_get", NULL ) )
    {
        remmina_pref.periodic_rmnews_last_get =
            g_key_file_get_int64( gkeyfile, "remmina_news", "periodic_rmnews_last_get", NULL );
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_news", "periodic_rmnews_get_count", NULL ) )
        remmina_pref.periodic_rmnews_get_count =
            g_key_file_get_int64( gkeyfile, "remmina_news", "periodic_rmnews_get_count", NULL );
    else
    ...
    if( g_key_file_has_key( gkeyfile, "remmina_news", "periodic_rmnews_uuid_prefix", NULL ) )
        remmina_pref.periodic_rmnews_uuid_prefix =
            g_key_file_get_string( gkeyfile, "remmina_news", "periodic_rmnews_uuid_prefix", NULL );
    else
...
gboolean remmina_pref_save( void )
{
    ...
    g_key_file_set_boolean(
        gkeyfile, "remmina_pref", "deny_screenshot_clipboard", remmina_pref.deny_screenshot_clipboard );
    ...
    g_key_file_set_integer(
        gkeyfile, "remmina_pref", "floating_toolbar_placement", remmina_pref.floating_toolbar_placement );
    g_key_file_set_integer( gkeyfile, "remmina_pref", "toolbar_placement", remmina_pref.toolbar_placement );
    g_key_file_set_boolean(
        gkeyfile, "remmina_pref", "prevent_snap_welcome_message", remmina_pref.prevent_snap_welcome_message );
    g_key_file_set_string(
        gkeyfile, "remmina_pref", "last_quickconnect_protocol", remmina_pref.last_quickconnect_protocol );
    ...
    g_key_file_set_integer(
        gkeyfile, "remmina_pref", "fullscreen_toolbar_visibility", remmina_pref.fullscreen_toolbar_visibility );
    ...
    g_key_file_set_integer(
        gkeyfile, "remmina_pref", "vte_shortcutkey_select_all", remmina_pref.vte_shortcutkey_select_all );
    g_key_file_set_integer(
        gkeyfile, "remmina_pref", "vte_shortcutkey_increase_font", remmina_pref.vte_shortcutkey_increase_font );
    g_key_file_set_integer(
        gkeyfile, "remmina_pref", "vte_shortcutkey_decrease_font", remmina_pref.vte_shortcutkey_decrease_font );
    g_key_file_set_integer(
        gkeyfile, "remmina_pref", "vte_shortcutkey_search_text", remmina_pref.vte_shortcutkey_search_text );
    g_key_file_set_string( gkeyfile, "remmina_pref", "vte_font", remmina_pref.vte_font ? remmina_pref.vte_font : "" );
    g_key_file_set_string(
        gkeyfile, "remmina_pref", "grab_color", remmina_pref.grab_color ? remmina_pref.grab_color : "" );
    ...
    g_key_file_set_string( gkeyfile,
                           "ssh_colors",
                           "background",
                           remmina_pref.color_pref.background ? remmina_pref.color_pref.background : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "cursor", remmina_pref.color_pref.cursor ? remmina_pref.color_pref.cursor : "" );
    g_key_file_set_string( gkeyfile,
                           "ssh_colors",
                           "cursor_foreground",
                           remmina_pref.color_pref.cursor_foreground ? remmina_pref.color_pref.cursor_foreground : "" );
    g_key_file_set_string( gkeyfile,
                           "ssh_colors",
                           "highlight",
                           remmina_pref.color_pref.highlight ? remmina_pref.color_pref.highlight : "" );
    g_key_file_set_string( gkeyfile,
                           "ssh_colors",
                           "highlight_foreground",
                           remmina_pref.color_pref.highlight_foreground ? remmina_pref.color_pref.highlight_foreground
                                                                        : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "colorBD", remmina_pref.color_pref.colorBD ? remmina_pref.color_pref.colorBD : "" );
    g_key_file_set_string( gkeyfile,
                           "ssh_colors",
                           "foreground",
                           remmina_pref.color_pref.foreground ? remmina_pref.color_pref.foreground : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color0", remmina_pref.color_pref.color0 ? remmina_pref.color_pref.color0 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color1", remmina_pref.color_pref.color1 ? remmina_pref.color_pref.color1 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color2", remmina_pref.color_pref.color2 ? remmina_pref.color_pref.color2 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color3", remmina_pref.color_pref.color3 ? remmina_pref.color_pref.color3 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color4", remmina_pref.color_pref.color4 ? remmina_pref.color_pref.color4 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color5", remmina_pref.color_pref.color5 ? remmina_pref.color_pref.color5 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color6", remmina_pref.color_pref.color6 ? remmina_pref.color_pref.color6 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color7", remmina_pref.color_pref.color7 ? remmina_pref.color_pref.color7 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color8", remmina_pref.color_pref.color8 ? remmina_pref.color_pref.color8 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color9", remmina_pref.color_pref.color9 ? remmina_pref.color_pref.color9 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color10", remmina_pref.color_pref.color10 ? remmina_pref.color_pref.color10 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color11", remmina_pref.color_pref.color11 ? remmina_pref.color_pref.color11 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color12", remmina_pref.color_pref.color12 ? remmina_pref.color_pref.color12 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color13", remmina_pref.color_pref.color13 ? remmina_pref.color_pref.color13 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color14", remmina_pref.color_pref.color14 ? remmina_pref.color_pref.color14 : "" );
    g_key_file_set_string(
        gkeyfile, "ssh_colors", "color15", remmina_pref.color_pref.color15 ? remmina_pref.color_pref.color15 : "" );
    ...
    g_key_file_set_integer(
        gkeyfile, "remmina_news", "periodic_rmnews_get_count", remmina_pref.periodic_rmnews_get_count );
    g_key_file_set_string( gkeyfile,
                           "remmina_news",
...
void remmina_pref_add_recent( const gchar *protocol, const gchar *server )
{
    ...
    array =
        remmina_string_array_new_from_allocated_string( g_key_file_get_string( gkeyfile, "remmina_pref", key, NULL ) );
