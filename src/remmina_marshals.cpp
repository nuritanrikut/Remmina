                                   ...
                                   gpointer marshal_data )
{
    ...
    v_return = callback( data1, g_marshal_value_peek_int( param_values + 1 ), data2 );
                                          ...
                                          gpointer marshal_data )
{
    ...
    v_return = callback(
        data1, g_marshal_value_peek_int( param_values + 1 ), g_marshal_value_peek_string( param_values + 2 ), data2 );
